@php
    ...
    $items = [
        ...
        [
            'title' => 'Меню',
            'text' => 'Меню разнообразно, поэтому сообщите нам заранее, есть ли у вас есть какие-либо предпочтения по еде, аллергия на продукты или диетические ограничения. Далее вы сможете пройти опрос о своих вкусовых предпочтениях и напитках.'
        ],
        [
            'title' => 'Подарки',
            'text' => 'Самый главные подарок для нас - это ваш веселый и позитивный настрой! Однако, если вы желаете нам что-нибудь подарить, будем признательны за подарок в денежном эквиваленте :)',
        ],
        [
            'title' => 'Примечание',
