@php
    ...
    $items = [
        ...
        [
            'title' => 'Примечание',
            'text' => 'Будем благодарны, если вы воздержитесь активных и частых от криков "Горько" на празднике, ведь поцелуй — это искренний и сакральный знак выражения чувств.',
        ],
        [
            'title' => 'Подтверждение',
